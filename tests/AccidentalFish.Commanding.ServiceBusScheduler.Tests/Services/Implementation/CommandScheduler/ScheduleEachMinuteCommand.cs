...
{
    public class ScheduleEachMinuteCommand
    {
        ...
        public ScheduleEachMinuteCommand()
        {
        ...
        {
            // Act
            await Assert.ThrowsAsync<ArgumentNullException>(() => _testSubject.ScheduleEachMinuteCommand(null));
        }
        ...
        public async Task ShouldThrowExceptionIfInitialDateLessThanNow()
        {
            ...
            // Act
            await Assert.ThrowsAsync<ArgumentException>(() => _testSubject.ScheduleEachMinuteCommand(command, scheduleDate));
        }
